  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 md:px-10 max-w-6xl">
        {/* Title */}
        <h1 className="text-3xl bg-black/40 backdrop-blur-sm sm:text-3xl md:text-6xl font-extrabold text-white drop-shadow-xl bg-opacity-40 rounded-lg py-4 px-12 inline-block">
